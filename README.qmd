...
This step uses the environment.yml file to create the conda environment. There is also a file called `requirements.txt` that is used for deploying the app to [](shinyapps.io).
