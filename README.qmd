---
title: "NASEM 2021 Dairy Model - Shiny App"
format: gfm
---
...
> 
> ![](./docs/media/absc_logo.png){width=240px}
...
This step uses the `environment.yml` file to create the conda environment. There is also a file called `requirements.txt` that is used for deploying the app to [shinyapps.io](https://shinyapps.io).
...
4.  Press the play button at the top right corner of app.py to run the shiny app
