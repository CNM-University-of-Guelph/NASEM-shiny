    ...
    # shinyswatch.theme.flatly(),
        ...
        ui.nav("Animal Inputs",
               ...
               ui.panel_title("Animal Inputs"),
                ui.input_numeric("An_Parity_rl", "An_Parity_rl", 1, min=0),
                ui.input_numeric("Trg_MilkProd", "Trg_MilkProd", 25.062, min=0),
                ui.input_numeric("An_BW", "An_BW", 624.795, min=0),
                ui.input_numeric("An_BCS", "An_BCS", 3.5, min=0),
                ui.input_numeric("An_LactDay", "An_LactDay", 100, min=0),
                ui.input_numeric("Trg_MilkFatp", "Trg_MilkFatp", 4.55, min=0),
                ui.input_numeric("Trg_MilkTPp", "Trg_MilkTPp", 3.66, min=0),
                ui.input_numeric("Trg_MilkLacp", "Trg_MilkLacp", 4.85, min=0),
                ui.input_numeric("DMI", "DMI", 24.521, min=0),
                ui.input_numeric("An_BW_mature", "An_BW_mature", 700, min=0),
                ui.input_numeric("Trg_FrmGain", "Trg_FrmGain", 0.19, min=0),
                ui.input_numeric("An_GestDay", "An_GestDay", 46, min=0),
                ui.input_numeric("An_GestLength", "An_GestLength", 280, min=0),
                ui.input_numeric("Trg_RsrvGain", "Trg_RsrvGain", 0, min=0),
                ui.input_numeric("Fet_BWbrth", "Fet_BWbrth", 44.1, min=0),
                ui.input_numeric("An_AgeDay", "An_AgeDay", 820.8, min=0)
                ),
        ui.nav("Run Model",
